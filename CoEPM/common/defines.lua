...
country = {
	...
	CREATED_CB_VALID_TIME = 60,  -- how many months 
	...
	COLONIAL_POINTS_FOR_NON_CORE_BASE = 0.75,
	...
	COLONIZATION_COLONY_PROVINCE_MAINTAINANCE = 2.5,
	...
	COLONIZATION_CREATE_STATE_COST = 6000,
...
economy = {
	...
	GOODS_FOCUS_SWAP_CHANCE = 0.005, 						-- Percent increased chance that artisan wants to change goods independently of how well he is doing presently
	...
	SECOND_RANK_BASE_SHARE_FACTOR = 0, --0.1,
	CIV_BASE_SHARE_FACTOR = 0, --0.2,
	UNCIV_BASE_SHARE_FACTOR = 0, --0.3,
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0.10,				-- how fast pops are Hired when there is a medium demand
...
diplomacy = {
	...
	NEIGHBOUR_BONUS_INFLUENCE_PERCENT = 0.66, -- Bonus to neighbouring countries when influencing
...
pops = {
	...
	STATE_CREATION_ADMIN_LIMIT = 100, -- 0.01,
...
ai =
{
	COLONY_WEIGHT = 7.5, -- ai weight for colonising
	...
	PRODUCTION_WEIGHT = 0, -- ai weight for new production -- aeni was 0.5
